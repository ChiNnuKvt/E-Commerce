        ...
        <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
          <div className="row">
            ...
            <div className='col-md-8 center'>
              ...
              <p>Admin Doe</p>
              <p>
                <a href={`mailto:madipellirohith.123@gmail.com`}>Admin@example.com</a>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className='col-lg-8'>
            <div className='order-product row'>
                <div className="col-md-3 col-6">
                  <img src='./Assest/images/4.png' alt="product"/>
                </div>
              ...
              <div className='mt-3 mt-md-0 col-6 col-md-2 d-flex align-items-center flex-'>
               ...
               <div className='col-lg-3 d-flex align-items-end flex-column mt-5 subtotal-or'>
